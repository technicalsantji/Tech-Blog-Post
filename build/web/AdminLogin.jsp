                    ...
                    <div class="card m-5 gradiant-colors-1 border-success rounded-lg" data-aos="fade-right" style="box-shadow:1px 4px 4px 4px #9a9c99">
                        <div class="card-body mx-auto text-center">
                            ...
                            <form action="AdminLogin" method="post" autocomplete="off">
                                ...
                                <h6 class="card-title cti text-white">Admin Login here</h6>
                                <marquee>
                                    <span class="cti text-white">Admin only Login ,Not required Register becouse I am providing user id and password</span>
                                </marquee>
                                <%
                                ...
                                <div class="input-group mb-3 mt-3">
                                    ...
                                    <input type="text" name="aemail" class="form-control" placeholder="Enter the Email or phone  " required aria-label=" Enter the Email/ Phone" aria-describedby="basic-addon1">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control" name="apassword" required placeholder="Enter the Password" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
